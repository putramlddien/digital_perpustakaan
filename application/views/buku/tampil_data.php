...
<?php
echo anchor('buku/post','Tambah Data',array('class'=>'btn btn-primary btn-sm'))
?><br><br>
<div class="module">
...
foreach ($record->result() as $r) {
    $deskripsi = (strlen($r->deskripsi) > 50) ? substr($r->deskripsi, 0, 90) . '...' : $r->deskripsi;
    ...
    echo "<tr>
            ...
            <td style='text-align: center;'><a href='edit/$r->id_buku' class='btn btn-sm'>Edit</a></td>
            <td style='text-align: center;'><a href='delete/$r->id_buku/admin' class='btn btn-sm'>Delete</a></td>
          </tr>";
    $no++;
}
?>
